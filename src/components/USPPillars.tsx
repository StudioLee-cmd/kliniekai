...
const pillars = [
    {
        ...
        pillarLinks: [{ href: "/voice-ai", anchor: "ai telefonist voor klinieken" }, { href: "/chatbot", anchor: "ai chatbot voor klinieken" }],
    },
    {
        ...
        icon: <FiStar size={32} />,
        pillarLinks: [{ href: "/seo", anchor: "seo voor klinieken" }, { href: "/reviews", anchor: "review management voor klinieken" }],
    },
    {
        ...
        pillarLinks: [{ href: "/automatisering", anchor: "workflow automatisering voor klinieken" }, { href: "/crm", anchor: "crm voor klinieken" }],
    },
    {
        ...
        pillarLinks: [{ href: "/gratis-website", anchor: "gratis website voor klinieken" }],
    }
];
