...
const niche = siteDetails.niche?.toLowerCase() || "klinieken";
...
const workflows = [
  ...
  },
  {
    ...
    desc: `Klantspecifieke onderhoud- of opvolg-cycli automatisch beheerd. Voor Klinieken: no-show preventie via dubbele afspraakbevestiging, premium intake-flow via chatbot, post-behandeling review-verzoek met persoonlijke touch — terugkerende omzet zonder dat jij eraan hoeft te denken.`,
  },
];
...
const integrations = [
  { icon: BsWhatsapp, title: "WhatsApp Business", desc: "Het hoofdkanaal — 90% van klinieken-klanten checkt WhatsApp sneller dan e-mail." },
...
const painPoints = [
  {
    icon: BsXCircle,
    title: "Patiënten verwachten premium service maar receptie is overbelast",
    desc: `Wat had niemand opgevolgd. Een automatisch follow-up bericht had het opgelost.`,
  },
  {
    icon: BsClockHistory,
    title: "No-shows kosten premium behandelomzet",
    desc: `Tegen de tijd dat je terugbelt heeft de klant al een collega gebeld. Zonder automatische opvolging is het over.`,
  },
  {
    icon: BsGearFill,
    title: "Online zichtbaarheid achterblijft terwijl concurrerende klinieken meer investeren",
      ...
      <section className="py-12 md:py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            maar wel volle agendas willen. Premium zorg verdient premium bereikbaarheid.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
