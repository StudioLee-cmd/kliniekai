...
Slim overbooken is niet hetzelfde als wat luchtvaartmaatschappijen doen (waar passagiers worden weggestuurd als de vlucht vol blijkt). In een kliniek werkt het anders:

- Je identificeert welke slots historisch het hoogste no-show-percentage hebben
- Je boekt die slots dubbel met patiënten die historisch het minst no-shows hebben
...
![Reception desk in een Nederlandse kliniek met agenda-tablet, bloemen, koffie en clipboard](/images/blog/kliniek-slim-overbooken-no-shows-compenseren-2.jpg)

## Hoe je het systeem opzet — 4 stappen

### Stap 1: data verzamelen (60-90 dagen)

Voordat je begint met overbooken, heb je 60-90 dagen historische data nodig om no-show-percentages per slot/dag/patiënt-segment te bepalen. Voor klinieken met geïntegreerd HIS of agenda-systeem (Pluq, Mediportaal, Tetras) kan dit automatisch via een rapport.

Wat je in de data zoekt:
- No-show-percentage per dag/uur (heatmap van een week)
- No-show-percentage per type afspraak (intake, vervolg, behandeling)
- No-show-percentage per patiënt-segment (eerste bezoek, vaste, online geboekt, telefonisch, etc.)
- Trend over de laatste 6 maanden

### Stap 2: regels definiëren
...
- Vaste klanten met 0% no-show-historie
- Spoedafspraken (per definitie niet voorspelbaar)

### Stap 3: bevestigingsystem op groene-licht-basis
...
## Drie veelgemaakte fouten bij overbooking

- **Beginnen zonder data:** zonder historische no-show-percentages werkt het systeem op gokken. Verzamel eerst 60-90 dagen data.
- **Overbooken op alle slots tegelijk:** alleen op de slots met statistisch hoge no-show-kans. Op laag-risico slots boeken leidt tot constante overlap-stress.
- **Geen buffer-protocol:** als beide patiënten verschijnen en je hebt geen plan, krijg je een ontevreden patiënt en een 1-ster review. Het buffer-protocol is non-negotiable.

## De technische basis

Slim overbooken vereist een agendasysteem dat:

- Real-time no-show-percentages per slot/segment kan tonen
- Patiënt-historie per patiënt kan tonen (vorige no-shows)
- Bevestigingsstatus kan integreren in planning
- Dubbele boekingen kan toelaten met markering

Voor klinieken zonder dit systeem werkt het ook handmatig in een spreadsheet, maar de uitvoering is dan een halve FTE per week. Een [moderne kliniek-stack met geïntegreerde overbooking-logica](https://www.kliniekai.nl/gratis-website) doet dit automatisch.

Voor een complete uitleg van [afspraakherinneringen voor klinieken](https://www.kliniekai.nl/blog/afspraakherinneringen-kliniek-minder-no-shows) (de stap die voor overbooken komt), zie ons specifieke artikel.

## Wat het kost om dit op te zetten

- Setup en data-analyse: €450 tot €1.500 eenmalig (door specialist) of 12-24 uur eigen werk
- Software/tool: vaak inbegrepen in modern HIS-abonnement, anders €49-149 per maand voor een geïntegreerd platform
- Training van receptiebureau: 2-4 uur

Voor een complete kostenbreakdown van een [kliniek-systeem inclusief overbooking](https://www.kliniekai.nl/tarieven) en de Groei-of-Geld-Terug Garantie, zie de pagina hierboven. ROI is in 90 procent van Nederlandse klinieken positief binnen één maand.

## Begin klein, schaal slim

Slim overbooken is geen knop die je in één keer omzet. Begin met één type slot (bijvoorbeeld maandagochtend) en één regel (1 dubbele boeking per uur tussen 8:00-9:30). Meet de uitkomst over 4 weken. Werkt het zonder overlap-incidenten? Dan voeg je een tweede slot toe (vrijdag-namiddag). Werkt dat ook? Schaal je op naar patiënten met 2+ eerdere no-shows.

Drie maanden later draai je een werkend systeem dat 12-18 procent extra omzet binnenhaalt zonder extra personeel. Wil je weten hoe een [complete kliniek-aanpak inclusief slim overbooken](https://www.kliniekai.nl/voice-ai) eruit kan zien? Plan een vrijblijvend gesprek of bekijk de uitgewerkte aanpak online.

Lees ook onze [andere artikelen over kliniekvoering en operationele optimalisatie](https://www.kliniekai.nl/blog).
